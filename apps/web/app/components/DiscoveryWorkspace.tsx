...
const sections: SectionConfig[] = [
  {
    ...
    description:
      "Capture what the client does, how they grow, and what this implementation must enable.",
    fields: [
  ...
  },
  {
    ...
    description:
      "Document the current HubSpot footprint, connected systems, and migration context.",
    fields: [
      {
        key: "currentHubspotUsage",
        label: "Current HubSpot Usage",
        type: "textarea"
      },
  ...
  },
  {
    ...
    description:
      "Define objects, lifecycle logic, ownership, associations, and the structure that needs to exist in HubSpot.",
    fields: [
  ...
  },
  {
    ...
    description:
      "Capture the sales process, qualification logic, tasking, and reporting expectations.",
    fields: [
      {
  ...
  },
  {
    ...
    description:
      "Define segmentation, campaigns, forms, lead capture, email, and marketing reporting.",
    fields: [
  ...
  },
  {
    ...
    description:
      "Cover support flows, ticket routing, SLAs, and any portal or help-centre needs.",
    fields: [
  ...
  },
  {
    ...
    description:
      "Capture source systems, sync directions, imports, mapping, and dedupe concerns.",
    fields: [
      { key: "sourceSystems", label: "Source Systems", type: "list" },
      { key: "syncDirection", label: "Sync Direction", type: "textarea" },
      {
        key: "fieldMappingNeeds",
        label: "Field Mapping Needs",
        type: "textarea"
      },
      {
        key: "importRequirements",
  ...
  },
  {
    ...
    description:
      "Define naming rules, permissions, QA expectations, training, and handover needs.",
    fields: [
      {
  ...
  },
  {
    ...
    description:
      "Track blockers, dependencies, access gaps, assumptions, and whether custom development is likely.",
    fields: [
...
export default function DiscoveryWorkspace({
  ...
  const [discovery, setDiscovery] = useState<ProjectDiscovery>(
  ...
  function saveSection(section: DiscoverySectionKey) {
    ...
    startTransition(async () => {
      try {
        ...
        setMessage(
          `${sections.find((item) => item.key === section)?.title} saved`
        );
      } catch (saveError) {
        setError(
              ...
              <aside className="rounded-2xl border border-[rgba(255,255,255,0.07)] bg-background-card p-4">
                ...
                <div className="space-y-2">
                  {sections.map((section, index) => {
                    const complete = discovery.completedSections.includes(
                      section.key
                    );
                ...
                <div className="mt-8 flex flex-wrap items-center justify-between gap-4 border-t border-[rgba(255,255,255,0.07)] pt-6">
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-text-muted">
                      Each section saves independently and updates completion
                      status.
                    </p>
                  </div>
