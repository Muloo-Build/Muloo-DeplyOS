  ...
  return (
    <div className="space-y-6">
      <section className="rounded-3xl border border-zinc-800 bg-zinc-800/80 p-6 sm:p-8">
        ...
        <p className="mt-3 max-w-4xl text-sm text-zinc-300 sm:text-base">
      ...
      {loading ? (
        <div className="rounded-3xl border border-zinc-800 bg-zinc-800/70 p-6 text-sm text-zinc-300">
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1.2fr)_22rem]">
            ...
            <section className="rounded-3xl border border-zinc-800 bg-zinc-800/70 p-6">
              ...
              <div className="mt-5 grid gap-4 lg:grid-cols-[minmax(0,1fr)_auto]">
                <select
                  ...
                  className="w-full rounded-2xl border border-zinc-700 bg-zinc-900 px-4 py-3 text-sm text-white outline-none"
                >
              ...
              {selectedPortal ? (
                ...
                <div className="mt-5 rounded-2xl border border-dashed border-zinc-700 bg-zinc-900/70 p-5 text-sm text-zinc-400">
            ...
            <section className="rounded-3xl border border-zinc-800 bg-zinc-800/70 p-6">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                ...
                <button
                  ...
                  className="rounded-xl border border-zinc-700 bg-zinc-900 px-4 py-2 text-sm font-medium text-white transition hover:border-zinc-500"
                >
                  Load example brief
                </button>
              </div>
              ...
              <textarea
                ...
                className="mt-5 min-h-[360px] w-full rounded-2xl border border-zinc-700 bg-zinc-900 px-4 py-4 text-sm text-white outline-none placeholder:text-zinc-500"
              />
              ...
              <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                <button
                  ...
                  className="rounded-xl border border-zinc-700 bg-zinc-900 px-4 py-3 text-sm font-medium text-white transition hover:border-zinc-500 disabled:opacity-60"
                >
              ...
              <div className="mt-2 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                {responseBody ? (
                  <div className="flex flex-wrap gap-2">
                    {responseBody.plan.capabilityKey ? (
                      <span className="rounded-full bg-violet-500/12 px-3 py-1 text-xs uppercase tracking-[0.18em] text-violet-200">
                        {responseBody.plan.capabilityKey}
                      </span>
                    ) : null}
                    <span className="rounded-full bg-zinc-900 px-3 py-1 text-xs uppercase tracking-[0.18em] text-zinc-300">
                ...
                <div className="mt-5 space-y-5">
                  <div className="rounded-2xl border border-zinc-700 bg-zinc-900/70 p-5">
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="rounded-full bg-zinc-800 px-3 py-1 text-xs uppercase tracking-[0.18em] text-zinc-300">
                  ...
                  {responseBody.execution ? (
                    <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/10 p-5">
                      ...
                      <pre className="mt-4 max-h-[280px] overflow-auto rounded-2xl border border-zinc-700 bg-zinc-950 p-4 text-xs text-zinc-200">
          ...
          <div className="space-y-6">
            <section className="rounded-3xl border border-zinc-800 bg-zinc-800/70 p-6">
              ...
              {snapshotLoading ? (
                <p className="mt-4 text-sm text-zinc-500">Refreshing portal metadata...</p>
              ) : null}
            </section>
            ...
            <section className="rounded-3xl border border-zinc-800 bg-zinc-800/70 p-6">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
                ...
                <div className="rounded-2xl border border-zinc-700 bg-zinc-900/70 p-4 sm:col-span-2 xl:col-span-1">
                  <p className="text-xs uppercase tracking-[0.18em] text-zinc-500">
                    Custom objects
                  </p>
                  <p className="mt-2 text-2xl font-semibold text-white">
            ...
            <section className="rounded-3xl border border-zinc-800 bg-zinc-800/70 p-6">
              ...
              <div className="mt-4 space-y-3">
                {recentRuns.length > 0 ? (
                  recentRuns.map((run) => (
                    ...
                    >
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="rounded-full bg-zinc-800 px-2.5 py-1 text-[11px] uppercase tracking-[0.18em] text-zinc-300">
                  ...
                  <div className="rounded-2xl border border-dashed border-zinc-700 bg-zinc-900/70 p-4 text-sm text-zinc-400">
